...
$destination = "\\DISPLAYITSVR\DisplayIt-T\UserProfileMoves"
...
{ 
	...
	if ($answer -eq 0) 
	{
		...
		{	
            ...
            if ($f -eq "AppData\Roaming\Microsoft\Windows\Themes") { rename-item $currentLocalFolder "$currentLocalFolder.old" }
